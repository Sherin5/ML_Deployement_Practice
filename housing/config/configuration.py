from housing.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, \
    model_trained_config, model_evaluation_config, model_pusher_config, Training_Pipeline_config
...
class Configuration:
    ...
    def get_model_trainer_config(self)->model_trained_config:
        pass

    def model_evaluation_config(self)->model_evaluation_config:
        pass

    def model_pusher_config(self)->model_pusher_config:
        pass
